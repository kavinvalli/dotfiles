...
_G.packer_plugins = {
  ...
  ["uwu.vim"] = {
    ...
    loaded = true,
    path = "/Users/kavinvalli/.local/share/nvim/site/pack/packer/start/uwu.vim",
...
-- Config for: uwu.vim
time([[Config for uwu.vim]], true)
try_loadstring("\27LJ\2\n*\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\15k.themeing\frequire\0", "config", "uwu.vim")
time([[Config for uwu.vim]], false)
