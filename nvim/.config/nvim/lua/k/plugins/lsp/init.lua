-- Taken from https://github.com/JoosepAlviste/dotfiles
...
function M.on_attach(client, bufnr)
  ...
  buf_map('n', '<c-]>', [[<cmd>lua require('k.plugins.lsp').definitions()<cr>]], opts)
  ...
  buf_map('n', 'gf', [[<cmd>lua vim.lsp.buf.formatting_sync(nil, 1000)<cr>]], opts)
  -- buf_map("n", "gi", ":TSLspImportAll<CR>", opts)
